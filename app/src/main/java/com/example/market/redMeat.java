...
public class redMeat extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_red_meat);
    ...
    public void UpdateTable(){
        ...
        if (cursor.moveToFirst()) {
            ...
            TableLayout dbOutput = findViewById(R.id.dbOutput_redMeat);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            default:
                ...
                Cursor cursorUpdater = database.rawQuery("SELECT * FROM " + DBHelper.TABLE_MEAT, null);

                if (cursorUpdater != null) {
                    cursorUpdater.moveToPosition(indexStr);
                    index =  cursorUpdater.getInt(0);
                }
                Intent intent = new Intent(this, redMeatWin.class);
                Bundle b = new Bundle();
                b.putInt("key", index);
                intent.putExtras(b);
